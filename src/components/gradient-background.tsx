...
const GradientBackground: React.FC<GradientBackgroundProps> = ({
  ...
  const gradientStyles = {
    "--background-start-rgb": hexToRgb(mainColor, 0.05),
    "--background-middle-rgb": hexToRgb(mainColor, 0.4),
    "--background-end-rgb": hexToRgb(mainColor),
  };

  return (
    <main
      className="bg-gradient-to-b text-red-500/5 from-[var(--background-start-rgb)] via-[var(--background-middle-rgb)] to-[var(--background-end-rgb)]"
